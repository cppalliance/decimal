...
void test_constructor_rounding()
{
    ...
    BOOST_TEST_EQ(decimal32_t_t(1, 0), decimal32_t_t(1, 0));
    BOOST_TEST_EQ(decimal32_t_t(12'345'675, 0), decimal32_t_t(1'234'568, 1));
    BOOST_TEST_EQ(decimal32_t_t(-12'345'675, 0), decimal32_t_t(-1'234'568, 1));
    ...
    BOOST_TEST_EQ(decimal32_t_t(1, 0), decimal32_t_t(1, 0));
    BOOST_TEST_EQ(decimal32_t_t(12'345'675, 0), decimal32_t_t(1'234'567, 1));
    BOOST_TEST_EQ(decimal32_t_t(-12'345'675, 0), decimal32_t_t(-1'234'568, 1));
    ...
    BOOST_TEST_EQ(decimal32_t_t(12'345'675, 0), decimal32_t_t(1'234'568, 1));
    BOOST_TEST_EQ(decimal32_t_t(-12'345'675, 0), decimal32_t_t(-1'234'568, 1));
    BOOST_TEST_EQ(decimal32_t_t(55'555'555, 0), decimal32_t_t(5'555'556, 1));
    BOOST_TEST_EQ(decimal32_t_t(55'555'556, 0), decimal32_t_t(5'555'556, 1));
    ...
    // Edge case
    BOOST_TEST_EQ(decimal32_t_t(99'999'999), decimal32_t_t(1, 8));
}
