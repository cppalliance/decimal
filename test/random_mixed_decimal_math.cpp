...
int main()
{
    ...
    random_mixed_multiplication<decimal32, decimal64>(0, 5'000'000);
    random_mixed_multiplication<decimal32, decimal64>(0LL, 5'000'000LL);
    random_mixed_multiplication<decimal64, decimal32>(0, 5'000'000);
    random_mixed_multiplication<decimal64, decimal32>(0LL, 5'000'000LL);

    random_mixed_multiplication<decimal32, decimal64>(-5'000'000, 0);
    random_mixed_multiplication<decimal32, decimal64>(-5'000'000LL, 0LL);
    random_mixed_multiplication<decimal64, decimal32>(-5'000'000, 0);
    random_mixed_multiplication<decimal64, decimal32>(-5'000'000LL, 0LL);

    random_mixed_multiplication<decimal32, decimal64>(-5'000'000, 5'000'000);
    random_mixed_multiplication<decimal32, decimal64>(-5'000'000LL, 5'000'000LL);
    random_mixed_multiplication<decimal64, decimal32>(-5'000'000, 5'000'000);
    random_mixed_multiplication<decimal64, decimal32>(-5'000'000LL, 5'000'000LL);
