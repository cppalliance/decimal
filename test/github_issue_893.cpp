...
void test_128()
{
    const std::array<boost::int128::uint128_t, 6> comp_values = {
        BOOST_DECIMAL_DETAIL_INT128_UINT128_C(1234567890123456789012345678901234),
        BOOST_DECIMAL_DETAIL_INT128_UINT128_C(12345678901234567890123456789012345),
        BOOST_DECIMAL_DETAIL_INT128_UINT128_C(123456789012345678901234567890123456),
        BOOST_DECIMAL_DETAIL_INT128_UINT128_C(1234567890123456789012345678901234567),
        BOOST_DECIMAL_DETAIL_INT128_UINT128_C(12345678901234567890123456789012345678),
        BOOST_DECIMAL_DETAIL_INT128_UINT128_C(123456789012345678901234567890123456789),
    };
