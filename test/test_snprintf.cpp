...
void test_locales()
{
    ...
    snprintf(printf_buffer, sizeof(printf_buffer), "%.4De", decimal64_t_t{11897, -2});
...
void test_bootstrap()
{
    ...
    const char* format = std::is_same<T, decimal32_t_t>::value ? "%H" :
                         std::is_same<T, decimal64_t_t>::value ? "%D" : "%DD";

    const char* general_format = std::is_same<T, decimal32_t_t>::value ? "%Hg" :
                                 std::is_same<T, decimal64_t_t>::value ? "%Dg" : "%DDg";

    const char* general_upper_format = std::is_same<T, decimal32_t_t>::value ? "%HG" :
                                       std::is_same<T, decimal64_t_t>::value ? "%DG" : "%DDG";

    const char* three_digit_format = std::is_same<T, decimal32_t_t>::value ? "%.3H" :
                                     std::is_same<T, decimal64_t_t>::value ? "%.3D" : "%.3DD";

    const char* scientific_format = std::is_same<T, decimal32_t_t>::value ? "%He" :
                                    std::is_same<T, decimal64_t_t>::value ? "%De" : "%DDe";

    const char* four_digit_scientific_format = std::is_same<T, decimal32_t_t>::value ? "%.4He" :
                                               std::is_same<T, decimal64_t_t>::value ? "%.4De" : "%.4DDe";

    const char* four_digit_upper_sci_format =  std::is_same<T, decimal32_t_t>::value ? "%.5HE" :
                                               std::is_same<T, decimal64_t_t>::value ? "%.5DE" : "%.5DDE";

    const char* fixed_format = std::is_same<T, decimal32_t_t>::value ? "%Hf" :
                               std::is_same<T, decimal64_t_t>::value ? "%Df" : "%DDf";

    const char* two_digit_fixed_format = std::is_same<T, decimal32_t_t>::value ? "%.2Hf" :
                                         std::is_same<T, decimal64_t_t>::value ? "%.2Df" : "%.2DDf";

    const char* hex_format = std::is_same<T, decimal32_t_t>::value ? "%Ha" :
                             std::is_same<T, decimal64_t_t>::value ? "%Da" : "%DDa";

    const char* hex_upper_format = std::is_same<T, decimal32_t_t>::value ? "%HA" :
                                   std::is_same<T, decimal64_t_t>::value ? "%DA" : "%DDA";

    const char* one_digit_hex_upper_format = std::is_same<T, decimal32_t_t>::value ? "%.1HA" :
                                             std::is_same<T, decimal64_t_t>::value ? "%.1DA" : "%.1DDA";
...
void test_fuzzer_crash(const char* c_data)
{
    ...
    for (std::size_t i {}; i < 4; ++i)
    {
        ...
        boost::decimal::decimal32_t_t f_val {};
        ...
        boost::decimal::decimal64_t_t val {};
        ...
        boost::decimal::decimal128_t_t ld_val {};
...
int main()
{
    test_bootstrap<decimal32_t_t>();
    test_bootstrap<decimal64_t_t>();
    test_bootstrap<decimal128_t_t>();
    ...
    test_bad_input<decimal32_t_t>();
    test_bad_input<decimal64_t_t>();
    test_bad_input<decimal128_t_t>();
