...
Decimal floating-point arithmetic is crucial for many applications, particularly in financial and scientific computing. 
While several C++ decimal floating-point packages exist, they often lack IEEE 754 conformance, interoperability with the C++ Standard Template Library (STL), or both, and have limited portability. 
...
The decimal system provides three IEEE-754 compliant types: \code{decimal32}, \code{decimal64}, and \code{decimal128}, as well as three analogous but non-conformant types: 
\code{decimal32\_fast}, \code{decimal64\_fast}, and \code{decimal128\_fast}.
