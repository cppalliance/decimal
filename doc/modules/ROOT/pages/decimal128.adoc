...
The encoding of Decimal128 is in the `xref:conversions.adoc[BID format]`.
...
constexpr decimal128(UnsignedIntegral coeff, Integral exp, bool sign = false) noexcept;

template <typename SignedIntegral, typename Integral>
constexpr decimal128(SignedIntegral coeff, Integral exp, bool sign = false) noexcept;
