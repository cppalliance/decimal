...
constexpr decimal64_fast(UnsignedIntegral coeff, Integral exp, bool sign = false) noexcept;

template <typename SignedIntegral, typename Integral>
constexpr decimal64_fast(SignedIntegral coeff, Integral exp) noexcept;
