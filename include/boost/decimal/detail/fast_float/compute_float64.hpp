...
#ifndef BOOST_DECIMAL_DETAIL_FAST_FLOAT_COMPUTE_FLOAT64_HPP
#define BOOST_DECIMAL_DETAIL_FAST_FLOAT_COMPUTE_FLOAT64_HPP
...
BOOST_DECIMAL_CONSTEXPR_VARIABLE double double_powers_of_ten[] = {
...
BOOST_DECIMAL_CXX20_CONSTEXPR auto compute_float64(std::int64_t power, std::uint64_t i, bool negative, bool& success) noexcept -> double
{
    constexpr auto smallest_power = -325;
    constexpr auto largest_power = 308;
    ...
    if (BOOST_DECIMAL_UNLIKELY((real_exponent < 1) || (real_exponent > 2046)))
    {
        success = false;
        return 0;
    }
