...
private:
    ...
    using d128_fast_coeffs_t = std::array<decimal128_fast, 15>;
...
public:
    ...
    {{
        ...
        +::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(394735489323855), UINT64_C(10282954930524890450) }, -35 },
        -::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(262657820647143), UINT64_C(7801536535536173172) }, -36 },
        -::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(185564311701532), UINT64_C(15687007158497646588) }, -37 },
        +::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(525244016002584), UINT64_C(12277750447068982866) }, -38 },
        -::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(358384752584293), UINT64_C(18370286456371002882) }, -39 },
        -::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(179773779887752), UINT64_C(17772011513518515048) }, -40 },
        +::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(56715128386205), UINT64_C(15292499466693711883) }, -40 },
        -::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(473428701855329), UINT64_C(926484760170384186) }, -42 },
        +::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(513818468174601), UINT64_C(18105240268308765734) }, -44 },
        +::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(306743667337648), UINT64_C(15567754919026551912) }, -44 },
        -::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(366931412745108), UINT64_C(2220247416524400302) }, -45 },
        +::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(189307984255553), UINT64_C(8448217616480074192) }, -46 },
        +::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(239089604329878), UINT64_C(14831803080673374292) }, -48 },
        -::boost::decimal::decimal128 { boost::int128::uint128_t { UINT64_C(130092671757244), UINT64_C(16458215134170057406) }, -48 },
    }};
    ...
    {{
         ...
         +::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(394735489323855), UINT64_C(10282954930524890450) }, -35 },
         -::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(262657820647143), UINT64_C(7801536535536173172) }, -36 },
         -::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(185564311701532), UINT64_C(15687007158497646588) }, -37 },
         +::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(525244016002584), UINT64_C(12277750447068982866) }, -38 },
         -::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(358384752584293), UINT64_C(18370286456371002882) }, -39 },
         -::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(179773779887752), UINT64_C(17772011513518515048) }, -40 },
         +::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(56715128386205), UINT64_C(15292499466693711883) }, -40 },
         -::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(473428701855329), UINT64_C(926484760170384186) }, -42 },
         +::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(513818468174601), UINT64_C(18105240268308765734) }, -44 },
         +::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(306743667337648), UINT64_C(15567754919026551912) }, -44 },
         -::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(366931412745108), UINT64_C(2220247416524400302) }, -45 },
         +::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(189307984255553), UINT64_C(8448217616480074192) }, -46 },
         +::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(239089604329878), UINT64_C(14831803080673374292) }, -48 },
         -::boost::decimal::decimal128_fast { boost::int128::uint128_t { UINT64_C(130092671757244), UINT64_C(16458215134170057406) }, -48 },
    }};
};
...
template <>
constexpr auto riemann_zeta_series_or_pade_expansion<decimal128_fast>(decimal128_fast x) noexcept
{
    constexpr decimal128_fast one { 1 };

    const decimal128_fast dx { x - one };
