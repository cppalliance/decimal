...
public:
    ...
    friend BOOST_DECIMAL_CXX20_CONSTEXPR auto to_bid_d32f(decimal32_fast val) noexcept -> std::uint32_t;
    friend BOOST_DECIMAL_CXX20_CONSTEXPR auto from_bid_d32f (std::uint32_t bits) noexcept -> decimal32_fast;
};
