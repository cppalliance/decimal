...
template <>
static constexpr decimal128 e_v<decimal128> = decimal128{detail::uint128{UINT64_C(147358353192158),
...
template <>
static constexpr decimal128 log2e_v<decimal128> = decimal128{detail::uint128{UINT64_C(78208654878293),
...
template <>
static constexpr decimal128 log10e_v<decimal128> = decimal128{detail::uint128{UINT64_C(235431510388986),
...
template <>
static constexpr decimal128 pi_v<decimal128> = decimal128{detail::uint128{UINT64_C(170306079004327),
...
template <>
static constexpr decimal128 pi_over_four_v<decimal128> = decimal128{detail::uint128{UINT64_C(42576519751081932),
...
template <>
static constexpr decimal128 inv_pi_v<decimal128> = decimal128{detail::uint128{UINT64_C(172556135062039),
...
template <>
static constexpr decimal128 inv_sqrtpi_v<decimal128> = decimal128{detail::uint128{UINT64_C(305847786088084),
...
template <>
static constexpr decimal128 ln2_v<decimal128> = decimal128{detail::uint128{UINT64_C(375755839507647),
...
template <>
static constexpr decimal128 ln10_v<decimal128> = decimal128{detail::uint128{UINT64_C(124823388007844),
...
template <>
static constexpr decimal128 sqrt2_v<decimal128> = decimal128{detail::uint128{UINT64_C(76664670834168),
...
template <>
static constexpr decimal128 sqrt3_v<decimal128> = decimal128{detail::uint128{UINT64_C(93894662421072),
...
template <>
static constexpr decimal128 inv_sqrt2_v<decimal128> = decimal128{detail::uint128{UINT64_C(383323354170843),
...
template <>
static constexpr decimal128 inv_sqrt3_v<decimal128> = decimal128{detail::uint128{UINT64_C(312982208070241),
...
template <>
static constexpr decimal128 egamma_v<decimal128> = decimal128{detail::uint128{UINT64_C(312909238939453),
...
template <>
static constexpr decimal128 phi_v<decimal128> = decimal128{detail::uint128{UINT64_C(87713798287901),
